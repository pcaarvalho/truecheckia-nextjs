...
const plans: Plan[] = [
  {
    ...
    features: [
      { name: "10 análises por mês", included: true },
      ...
      { name: "Detecção multi-idioma", included: false },
  ...
  },
  {
    ...
    popular: true,
    features: [
      { name: "1,000 análises por mês", included: true },
      { name: "Análises básicas", included: true },
      { name: "Análises avançadas", included: true },
      { name: "API access", included: true },
      { name: "Suporte prioritário", included: true },
      { name: "Histórico completo", included: true },
      { name: "Detecção multi-idioma", included: true },
      { name: "Relatórios detalhados", included: true },
      { name: "Team management", included: false },
      { name: "Custom reporting", included: false }
    ],
    buttonText: "Iniciar Teste Pro",
    buttonVariant: "default"
  },
  {
    name: "Enterprise",
    slug: "ENTERPRISE",
    description: "Para empresas que precisam de soluções personalizadas",
    monthlyPrice: 0,
    yearlyPrice: 0,
