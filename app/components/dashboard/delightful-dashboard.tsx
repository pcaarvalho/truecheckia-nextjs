...
import EnhancedStatsCard from '@/app/components/dashboard/enhanced-stats-card';
import PageTransition, { StaggeredContainer, CardGridAnimation } from '@/app/components/animations/page-transitions';
import SuccessAnimation, { useSuccessAnimation } from '@/app/components/animations/success-animations';
import EasterEggs, { LongHoverEasterEgg, FunTooltip } from '@/app/components/animations/easter-eggs';
import AnimatedTooltip from '@/app/components/animations/tooltip-animations';
import EmptyState from '@/app/components/illustrations/empty-states';
          ...
          <motion.div className="space-y-4">
            ...
            >
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center">
                <LongHoverEasterEgg
                  onActivate={() => console.log('Hidden message!')}
                  hoverDuration={3000}
                >
