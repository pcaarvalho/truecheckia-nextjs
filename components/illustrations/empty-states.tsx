...
const encouragingMessages = [
  ...
  "How about starting a new analysis?",
  "We're excited to see your results!",
  "Let's discover something amazing together!",
  "Your next analysis could be the best one!",
  "We're here to help you!",
  "Every analysis is a new discovery!",
];
    ...
    switch (type) {
      ...
      case 'no-files':
        return {
          ...
          illustration: <FloatingFiles />,
          actionLabel: actionLabel || 'Upload File',
        };
      case 'error':
        return {
          title: title || 'Oops! Something went wrong',
          description: description || 'But don\'t worry, we\'re working to fix it.',
